...
class SegmentEditorFastMarchingEffect(AbstractScriptedSegmentEditorEffect):
  ...
  def icon(self):
    # It should not be necessary to modify this method
    iconPath = os.path.join(os.path.dirname(__file__), 'Resources/Icons/FastMarching.png')
...
<p></html>"""
  ...
  def fastMarching(self,percentMax):
    ...
    logging.info('FastMarching march is still developing...')
    return 
    import vtkSlicerSegmentationsModuleLogicPython as vtkSlicerSegmentEditorFastMarchingModuleLogicPython
