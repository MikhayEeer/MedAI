...
class LanguageToolsWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  def updateGUIFromSettings(self):
    ...
    try:
      ...
      moduleTSFolder = os.path.join(moduleDir, 'Resources')
      self.ui.localTsFolderPathLineEdit.currentPath = moduleTSFolder #settings.value("localTsFolderPath", self.resourcePath('TS/'))
